<template>
    <div class="relative w-full h-dvh overflow-hidden">
        <div class="absolute z-20">
            ...
            <a
                id="web"
                class="bg-red-800 transition-bg duration-500"
            ...
            <a
                id="astronomy"
                class="bg-blue-800 transition-bg duration-500"
            ...
            <a
                id="worldbuilding"
                class="bg-orange-800 transition-bg duration-500"
            ...
            <a
                id="fractal"
                class="bg-purple-800 transition-bg duration-500"
